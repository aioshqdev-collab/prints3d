...
5. Add `ADMIN_ACCESS_TOKEN` to `.env.local`. Visit `/admin-login` and enter that token to open `/admin`.
6. Add `RESEND_API_KEY` and `ORDER_FROM_EMAIL` if you want automatic order confirmation emails.
